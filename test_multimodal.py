...
train_acc, train_fp, train_fn, train_fp_list, train_fn_list = compute_binary_accuracy(model_M, model_LM, dataloader_train, alphas)
test_acc, test_fp, test_fn, test_fp_list, test_fn_list = compute_binary_accuracy(model_M, model_LM, dataloader_test, alphas)
