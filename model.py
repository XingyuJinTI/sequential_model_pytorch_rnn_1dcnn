...
class cnn_Classifier(nn.Module):
    ...
    def forward(self, landmarks, lengths):
        ...
        landmarks = self.lc1(self.dropout(landmarks))   # (b x seq, 1)
        ...
        # landmarks = self.p3(F.relu(self.bn6(self.conv6(F.relu(self.bn5(self.conv5(self.p2(F.relu(self.bn4(self.conv4(F.relu(self.bn3(self.conv3(self.p1(F.relu(self.bn2(self.conv2(F.relu(self.bn1(self.conv1(landmarks.permute(1, 2, 0))))))))))))))))))))))
        # landmarks = F.relu(self.bn2(self.conv2(F.relu(self.bn1(self.conv1(landmarks.permute(1, 2, 0)))))))
        # landmarks = F.relu(self.bn5(self.conv5(self.p2(F.relu(self.bn4(self.conv4(F.relu(self.bn3(self.conv3(self.p1(F.relu(self.bn2(self.conv2(F.relu(self.bn1(self.conv1(landmarks.permute(1, 2, 0))))))))))))))))))
