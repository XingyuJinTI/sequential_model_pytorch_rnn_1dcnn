...
# model Distortion
model_LM = biGRU_Classifier(int(68*67/2), 128, 1, n_layer=3)
...
model_LM.load_state_dict(torch.load("models/distortion_models/biGRU_L3.pt"))
...
dataset_train = LM_M_ListListTest(root_M='/datasets/mc_m_min16frame/', root_LM='/datasets/move_closer/Data_Distortion/', fileList='/datasets/mc_m_min16frame/TrainListM.txt')
dataloader_train = data.DataLoader(dataset_train, batch_size=1, shuffle=False, num_workers=0)#, collate_fn=pad_collate)

dataset_test = LM_M_ListListTest(root_M='/datasets/mc_m_min16frame/', root_LM='/datasets/move_closer/Data_Distortion/', fileList='/datasets/mc_m_min16frame/TestListM.txt')
dataloader_test = data.DataLoader(dataset_test, batch_size=1, shuffle=False, num_workers=0)#, collate_fn=pad_collate)


dataset_train_wo_M = LM_exclM_ListTest(root='/datasets/move_closer/Data_Distortion/', fileList='/datasets/mc_m_min16frame/TrainListLM_wo_M.txt')
dataloader_train_wo_M = data.DataLoader(dataset_train_wo_M, batch_size=1, shuffle=False, num_workers=0)#, collate_fn=pad_collate)

dataset_test_wo_M = LM_exclM_ListTest(root='/datasets/move_closer/Data_Distortion/', fileList='/datasets/mc_m_min16frame/TestListLM_wo_M.txt')
